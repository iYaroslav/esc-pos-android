package sam.lab.posprinter.bluetooth;
	...
	private DeviceItemView makeItem(final BluetoothDevice device) {
		...
		switch (cls.getMajorDeviceClass()) {
			...
			case BluetoothClass.Device.Major.WEARABLE:
				if (cls.getDeviceClass() == BluetoothClass.Device.WEARABLE_WRIST_WATCH) resId = R.drawable.ic_watch_24dp;
				break;
			case BluetoothClass.Device.Major.TOY:
				if (cls.getDeviceClass() == BluetoothClass.Device.TOY_CONTROLLER) resId = R.drawable.ic_gamepad_24dp;
				break;
			case BluetoothClass.Device.Major.AUDIO_VIDEO:
				if (cls.getDeviceClass() == BluetoothClass.Device.AUDIO_VIDEO_HEADPHONES) resId = R.drawable.ic_headset_24dp;
